 ...
 * 
 * @author zeliya
 *test case name: Edit_OppurtunitiesWith_MassEditButton_LeadSource_Website
 *test case id: tc_16_7
 */
public class Edit_OppurtunitiesWith_MassEditButton_LeadSource_Website {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/* 5.select the "Website" by clicking  on the "Lead Source" drop down menu */
		 ...
		 sel.selectByVisibleText("Web Site");
				...
				for(int j=0;j<oppName.length;j++)
				{
					if(d2.equals(oppName[j]))
					 ...
					 String x1=	"//table[@class='lvt small']/tbody/tr[*]/td[3]/a[text()='"+oppName[j]+"']";
				 	 ...
				 	 driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
				 	 String expValue ="Web Site";
				 	 String actvalue = driver.findElement(By.xpath("//font[text()='Web Site']")).getText();
				 	 driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);

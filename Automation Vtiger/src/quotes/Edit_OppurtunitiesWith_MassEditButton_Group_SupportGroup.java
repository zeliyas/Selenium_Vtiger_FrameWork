 ...
 */
public class Edit_OppurtunitiesWith_MassEditButton_Group_SupportGroup {
				...
				for(int j=0;j<oppName.length;j++)
				{
					if(d2.equals(oppName[j]))
					 ...
					 String x1=	"//table[@class='lvt small']/tbody/tr[*]/td[3]/a[text()='"+oppName[j]+"']";
				 	 ...
				 	 Thread.sleep(4000);
				 	 String expValue ="Support Group";
				 	 String actvalue = driver.findElement(By.xpath("//a[text()='Support Group']")).getText();
				 	 driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);

...
//		wLib.waitForCompleteElementToLoad(driver.findElement(By.xpath("//tbody/tr[1]/td[8]/a[text()='Contacts']")));
	...
	//	js.executeScript("window.scrollBy(0,200)");
		...
		/* try
		 { Assert.assertTrue(data1.contains(organization));
	 ...
	 //   Assert.assertEquals(value, value1, output4+oppName[i]+output5); //if fails then print this
	  //  System.out.println(output1); //if true then print this
		...
		/* try
		 ...
		 Assert.assertTrue(data2.contains(product), output4 );
		 System.out.println(output3);
		String data3= driver.findElement(By.id("mouseArea_Contact Name")).getText();
		
		/* try
		 { Assert.assertTrue(data3.contains(contact));
		 ...
		 Assert.assertTrue(data3.contains(contact), output6 );
		 System.out.println(output5);
		 
		String data4 = driver.findElement(By.id("mouseArea_Subject")).getText();
	
		/* try
		 { Assert.assertTrue(data4.contains(quoteName));
		 ...
		 Assert.assertTrue(data4.contains(quoteName), output8 );
		 System.out.println(output7);
